...
export function ProjectsApp() {
  const fetchProjects = useCallback(async (signal: AbortSignal) => (await projectsClient.listProjects({}, { signal })).projects, []);
  ...
  function body() {
    if (error !== null && projects == null) return <ErrorCard text="Cannot load the projects right now." retry={refresh} />;

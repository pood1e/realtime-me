    ...
    <div className="grid gap-4 lg:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardAction>
            <Badge variant={githubBadgeVariant(github.state)} aria-label={githubStatusTitle(github.state)}>{githubIcon(github.state)}</Badge>
          </CardAction>
        </CardHeader>
      ...
      {github.lastError && (
        <Card>
          <CardHeader>
            ...
            <CardAction><InlineTime value={github.lastErrorTime} /></CardAction>
          </CardHeader>

# Super Manager AG-UI Dart protocol package
...
上游通用 HTTP client、重试和状态管理已删除。Super Manager 必须使用自己的私有 CA/mTLS、bearer、sequence replay transport；项目中不得再引入第二套 AG-UI wire model。

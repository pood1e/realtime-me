...
import { compactText, formatPercent } from "@realtime-me/status-web/lib/format";
import { onlineStateLabel } from "@realtime-me/status-web/lib/status";
...
export function StatusBadge({ state }: { state?: OnlineState | undefined }) {

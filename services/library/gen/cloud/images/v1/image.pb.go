...
// 	protoc        (unknown)
// source: cloud/images/v1/image.proto
...
func (x *Image) Reset() {
	*x = Image{}
	mi := &file_cloud_images_v1_image_proto_msgTypes[0]
...
func (x *ImageAlbum) Reset() {
	*x = ImageAlbum{}
	mi := &file_cloud_images_v1_image_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ImageAlbum) Descriptor() ([]byte, []int) {
	return file_cloud_images_v1_image_proto_rawDescGZIP(), []int{1}
}
...
func (x *ImageLink) Reset() {
	*x = ImageLink{}
	mi := &file_cloud_images_v1_image_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ImageLink) Descriptor() ([]byte, []int) {
	return file_cloud_images_v1_image_proto_rawDescGZIP(), []int{2}
}
...
var File_cloud_images_v1_image_proto protoreflect.FileDescriptor
...
const file_cloud_images_v1_image_proto_rawDesc = "" +
	...
	"revokeTimeB:Z8github.com/pood1e/realtime-me/services/library/gen/cloud/images/v1;imagesv1b\x06proto3"

var (
	file_cloud_images_v1_image_proto_rawDescOnce sync.Once
	file_cloud_images_v1_image_proto_rawDescData []byte
)

func file_cloud_images_v1_image_proto_rawDescGZIP() []byte {
	file_cloud_images_v1_image_proto_rawDescOnce.Do(func() {
		file_cloud_images_v1_image_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cloud_images_v1_image_proto_rawDesc), len(file_cloud_images_v1_image_proto_rawDesc)))
	})
...
var file_cloud_images_v1_image_proto_depIdxs = []int32{
	...
	4, // 4: cloud.images.v1.ImageAlbum.create_time:type_name -> google.protobuf.Timestamp
	4, // 5: cloud.images.v1.ImageLink.create_time:type_name -> google.protobuf.Timestamp
	4, // 6: cloud.images.v1.ImageLink.revoke_time:type_name -> google.protobuf.Timestamp
...
func init() { file_cloud_images_v1_image_proto_init() }
func file_cloud_images_v1_image_proto_init() {
	if File_cloud_images_v1_image_proto != nil {
		return
	}
	type x struct{}
	...
	file_cloud_images_v1_image_proto_goTypes = nil
	file_cloud_images_v1_image_proto_depIdxs = nil
}

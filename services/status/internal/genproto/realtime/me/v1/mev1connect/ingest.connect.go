...
const (
	...
	EnrollmentServiceName = "realtime.me.v1.EnrollmentService"
	// IngestServiceName is the fully-qualified name of the IngestService service.
	IngestServiceName = "realtime.me.v1.IngestService"
)
...
const (
	...
	// EnrollDevice RPC.
	EnrollmentServiceEnrollDeviceProcedure = "/realtime.me.v1.EnrollmentService/EnrollDevice"
...
// EnrollmentServiceClient is a client for the realtime.me.v1.EnrollmentService service.
...
// NewEnrollmentServiceClient constructs a client for the realtime.me.v1.EnrollmentService service.
...
func NewEnrollmentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EnrollmentServiceClient {
	...
	enrollmentServiceMethods := v1.File_realtime_me_v1_ingest_proto.Services().ByName("EnrollmentService").Methods()
...
// EnrollDevice calls realtime.me.v1.EnrollmentService.EnrollDevice.
...
// EnrollmentServiceHandler is an implementation of the realtime.me.v1.EnrollmentService service.
...
func NewEnrollmentServiceHandler(svc EnrollmentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/realtime.me.v1.EnrollmentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEnrollmentServiceHandler) EnrollDevice(context.Context, *connect.Request[v1.EnrollDeviceRequest]) (*connect.Response[v1.EnrollDeviceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("realtime.me.v1.EnrollmentService.EnrollDevice is not implemented"))
}

// IngestServiceClient is a client for the realtime.me.v1.IngestService service.
...
// NewIngestServiceClient constructs a client for the realtime.me.v1.IngestService service. By
...
func NewIngestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IngestServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	ingestServiceMethods := v1.File_realtime_me_v1_ingest_proto.Services().ByName("IngestService").Methods()
...
// IngestServiceHandler is an implementation of the realtime.me.v1.IngestService service.
...
func NewIngestServiceHandler(svc IngestServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/realtime.me.v1.IngestService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIngestServiceHandler) RegisterScrapeTargets(context.Context, *connect.Request[v1.RegisterScrapeTargetsRequest]) (*connect.Response[v1.RegisterScrapeTargetsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("realtime.me.v1.IngestService.RegisterScrapeTargets is not implemented"))
}

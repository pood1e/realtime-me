...
// 	protoc        (unknown)
// source: realtime/me/v1/watch.proto
...
func (ChargeState) Descriptor() protoreflect.EnumDescriptor {
	return file_realtime_me_v1_watch_proto_enumTypes[0].Descriptor()
}

func (ChargeState) Type() protoreflect.EnumType {
	return &file_realtime_me_v1_watch_proto_enumTypes[0]
}
...
func (x *WatchSnapshot) Reset() {
	*x = WatchSnapshot{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[0]
...
func (x *DeviceInfo) Reset() {
	*x = DeviceInfo{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *HeartRateSample) Reset() {
	*x = HeartRateSample{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HeartRateSample) Descriptor() ([]byte, []int) {
	return file_realtime_me_v1_watch_proto_rawDescGZIP(), []int{2}
}
...
func (x *ActivityTotals) Reset() {
	*x = ActivityTotals{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ActivityTotals) Descriptor() ([]byte, []int) {
	return file_realtime_me_v1_watch_proto_rawDescGZIP(), []int{3}
}
...
func (x *WatchState) Reset() {
	*x = WatchState{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WatchState) Descriptor() ([]byte, []int) {
	return file_realtime_me_v1_watch_proto_rawDescGZIP(), []int{4}
}
...
func (x *ReportWatchSnapshotRequest) Reset() {
	*x = ReportWatchSnapshotRequest{}
	mi := &file_realtime_me_v1_watch_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportWatchSnapshotRequest) Descriptor() ([]byte, []int) {
	return file_realtime_me_v1_watch_proto_rawDescGZIP(), []int{5}
}
...
var File_realtime_me_v1_watch_proto protoreflect.FileDescriptor

const file_realtime_me_v1_watch_proto_rawDesc = "" +
	"\n" +
	"\x1arealtime/me/v1/watch.proto\x12\x0erealtime.me.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf0\x02\n" +
	...
	"recordTime\x12>\n" +
	"\n" +
	"heart_rate\x18\x03 \x01(\v2\x1f.realtime.me.v1.HeartRateSampleR\theartRate\x12G\n" +
	"\x0factivity_totals\x18\x04 \x01(\v2\x1e.realtime.me.v1.ActivityTotalsR\x0eactivityTotals\x12;\n" +
	"\vwatch_state\x18\x05 \x01(\v2\x1a.realtime.me.v1.WatchStateR\n" +
	"watchState\x12;\n" +
	"\vdevice_info\x18\x06 \x01(\v2\x1a.realtime.me.v1.DeviceInfoR\n" +
	"deviceInfo\"E\n" +
	"\n" +
	"DeviceInfo\x12!\n" +
	...
	"WatchProtoP\x01ZEgithub.com/pood1e/realtime-me/services/status/internal/genproto/realtime/me/v1;mev1\xa2\x02\x03RMX\xaa\x02\x0eRealtime.Me.V1\xca\x02\x0eRealtime\\Me\\V1\xe2\x02\x1aRealtime\\Me\\V1\\GPBMetadata\xea\x02\x10Realtime::Me::V1b\x06proto3"

var (
	file_realtime_me_v1_watch_proto_rawDescOnce sync.Once
	file_realtime_me_v1_watch_proto_rawDescData []byte
)

func file_realtime_me_v1_watch_proto_rawDescGZIP() []byte {
	file_realtime_me_v1_watch_proto_rawDescOnce.Do(func() {
		file_realtime_me_v1_watch_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_realtime_me_v1_watch_proto_rawDesc), len(file_realtime_me_v1_watch_proto_rawDesc)))
	})
...
func file_realtime_me_v1_watch_proto_init() {
	if File_realtime_me_v1_watch_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_realtime_me_v1_watch_proto_goTypes,
		DependencyIndexes: file_realtime_me_v1_watch_proto_depIdxs,
		EnumInfos:         file_realtime_me_v1_watch_proto_enumTypes,
		MessageInfos:      file_realtime_me_v1_watch_proto_msgTypes,
	}.Build()
	File_realtime_me_v1_watch_proto = out.File
	file_realtime_me_v1_watch_proto_goTypes = nil
	file_realtime_me_v1_watch_proto_depIdxs = nil
}

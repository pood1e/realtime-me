...
import (
	...
	authv1connect "example.com/cloud-drive/api/gen/cloud/auth/v1/authv1connect"
	booksv1connect "example.com/cloud-drive/api/gen/cloud/books/v1/booksv1connect"
	contentv1connect "example.com/cloud-drive/api/gen/cloud/content/v1/contentv1connect"
	drivev1connect "example.com/cloud-drive/api/gen/cloud/drive/v1/drivev1connect"
	imagesv1connect "example.com/cloud-drive/api/gen/cloud/images/v1/imagesv1connect"
	musicv1connect "example.com/cloud-drive/api/gen/cloud/music/v1/musicv1connect"
	systemv1connect "example.com/cloud-drive/api/gen/cloud/system/v1/systemv1connect"
	wallpapersv1connect "example.com/cloud-drive/api/gen/cloud/wallpapers/v1/wallpapersv1connect"

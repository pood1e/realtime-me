...
const (
	...
	ProfileServiceName = "realtime.me.site.v1.ProfileService"
)
...
const (
	...
	// RPC.
	ProfileServiceGetProfileProcedure = "/realtime.me.site.v1.ProfileService/GetProfile"
)

// ProfileServiceClient is a client for the realtime.me.site.v1.ProfileService service.
...
// NewProfileServiceClient constructs a client for the realtime.me.site.v1.ProfileService service.
...
func NewProfileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProfileServiceClient {
	...
	profileServiceMethods := v1.File_realtime_me_site_v1_profile_proto.Services().ByName("ProfileService").Methods()
...
// GetProfile calls realtime.me.site.v1.ProfileService.GetProfile.
...
// ProfileServiceHandler is an implementation of the realtime.me.site.v1.ProfileService service.
...
func NewProfileServiceHandler(svc ProfileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/realtime.me.site.v1.ProfileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProfileServiceHandler) GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("realtime.me.site.v1.ProfileService.GetProfile is not implemented"))
}

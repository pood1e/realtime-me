...
package sitev1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/pood1e/realtime-me/gen/go/realtime/me/site/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ProjectsServiceName = "realtime.me.site.v1.ProjectsService"
)
...
const (
	...
	// ListProjects RPC.
	ProjectsServiceListProjectsProcedure = "/realtime.me.site.v1.ProjectsService/ListProjects"
)

// ProjectsServiceClient is a client for the realtime.me.site.v1.ProjectsService service.
type ProjectsServiceClient interface {
	// ListProjects returns the curated projects in display order.
	ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error)
}

// NewProjectsServiceClient constructs a client for the realtime.me.site.v1.ProjectsService service.
...
func NewProjectsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectsServiceClient {
	...
	projectsServiceMethods := v1.File_realtime_me_site_v1_projects_proto.Services().ByName("ProjectsService").Methods()
...
// ListProjects calls realtime.me.site.v1.ProjectsService.ListProjects.
...
// ProjectsServiceHandler is an implementation of the realtime.me.site.v1.ProjectsService service.
...
func NewProjectsServiceHandler(svc ProjectsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/realtime.me.site.v1.ProjectsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectsServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("realtime.me.site.v1.ProjectsService.ListProjects is not implemented"))
}

...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/pood1e/realtime-me/gen/go/realtime/me/library/system/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "realtime.me.library.system.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/realtime.me.library.system.v1.HealthService/Check"
)

// HealthServiceClient is a client for the realtime.me.library.system.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the realtime.me.library.system.v1.HealthService
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_realtime_me_library_system_v1_health_service_proto.Services().ByName("HealthService").Methods()
...
// Check calls realtime.me.library.system.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the realtime.me.library.system.v1.HealthService
// service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/realtime.me.library.system.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("realtime.me.library.system.v1.HealthService.Check is not implemented"))
}
